    ...
    <body>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                 ...
                 {
                  $.ajax({
                   url:"<?php echo base_url(); ?>entreprise/pagination_candidat_liste/"+page,
                   method:"GET",
                   dataType:"json",
                 ...
                 {
                      $.ajax({
                       url:"<?php echo base_url(); ?>entreprise/fetch_search_candidat_pagination",
                       method:"POST",
                       data:{query:query},
                        beforeSend:function()
                        {
                ...
                $(document).on('click','.idp', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>entreprise/show_candidat_by_province",
                    method: "POST",
                    data:{
                      idp: idp
                    },
                ...
                $(document).on('click','.sexe', function(){
  
                  var sexe= $(this).attr('sexe');
                  // alert("band "+sexe);

                  $.ajax({
                    url:"<?php echo base_url(); ?>entreprise/show_candidat_by_sexe",
                    method: "POST",
                    data:{
                      sexe: sexe
                    },
                 ...
                 $(document).on('click','.idv', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>entreprise/show_candidat_by_ville",
                    method: "POST",
                    data:{
                      idv: idv
                    },
        ...
        $(document).ready(function(){
          var sample_data = new Bloodhound({
           ...
           prefetch:'<?php echo base_url(); ?>entreprise/fetch_auto',
           remote:{
            url:'<?php echo base_url(); ?>entreprise/fetch_auto/%QUERY',
            wildcard:'%QUERY'
           }
          });
