    ...
    <body>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                      ...
                                      <?php include('operation_detail.php') ?>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
            ...
            $(document).on('change', '#user_image3', function(event) {
              event.preventDefault();
              /* Act on the event */

              var extension2   = $('#user_image3').val().split('.').pop().toLowerCase();
              ...
              {  
                    ...
                    {   
                        ...
                        event.preventDefault(); 
                         var erreur = "Votre fichier doit être de l'extension PDF";
                         showErrrorMessage(erreur);  
                         $('#user_image3').val('');  
                         return false;  
                    }  
