			...
			<div class="form-group jf-inputwithicon">
				...
				<select data-placeholder="votre pays" name="idPays" class="form-control" required="">
					...
					if ($pays->num_rows() > 0) {
						...
						<?php
						foreach ($pays->result_array() as $key) {
							?>
							<option selected value="<?php echo($key['idPays']) ?>"><?php echo($key['nompays']) ?></option>
							<?php
						}
					}
			...
			<div class="form-group jf-inputwithicon">
				...
				<select data-placeholder="votre province" name="idprovince" id="id_province" class="form-control" required>
					...
					if ($provinces->num_rows() > 0) {
						...
						<?php
						foreach ($provinces->result_array() as $key) {
							?>
							<option value="<?php echo($key['idp']) ?>"><?php echo($key['nomp']) ?></option>
							<?php
						}
					}
		...
		<div class="col-md-6">
	        ...
	        <div class="col-md-12">
	        	<div class="form-group">
	        		...
	        		<input type="hidden" name="idv" id="idv" value="<?php echo($idv) ?>" />
