          ...
          <div class="top-menu d-flex align-items-center">
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                      ...
                      <div class="footer"><a href="<?php echo(base_url()) ?>user/notification">Voir toutes les notifications</a></div>
                  </div>
              </div>
              ...
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                      <a class="dropdown-item" href="<?php echo(base_url()) ?>user/profile"><i class="ik ik-user dropdown-icon"></i> Profile</a>
                      <a class="dropdown-item" href="<?php echo(base_url()) ?>user/basic"><i class="ik ik-settings dropdown-icon"></i> Mon compte</a>
