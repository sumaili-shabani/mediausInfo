    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item">
                    <a href="<?php echo(base_url()) ?>user/dashbord"><i class="ik ik-bar-chart-2"></i><span>Tableau de bord</span></a>
                </div>
                <!-- <div class="nav-item">
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="<?php echo(base_url()) ?>user/article" class="menu-item">Ajouter un article</a>
                ...
                <div class="nav-item">
                    <a href="<?php echo(base_url()) ?>user/offres_emplois"><i class="ik ik-clipboard"></i><span>Offres d'emplois</span></a>
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                         ...
                         <a href="<?php echo(base_url()) ?>user/notification" class="menu-item">Notification</a>
                    </div>
                </div>
