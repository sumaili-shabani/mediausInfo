        ...
        <div class="card">
            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true">Mes demandes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="false">basique</a>
                </li>

                 <li class="nav-item">
                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-photo" role="tab" aria-controls="pills-setting" aria-selected="false">Photo</a>
                </li>

                 <li class="nav-item">
                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-secure" role="tab" aria-controls="pills-setting" aria-selected="false">Sécurité</a>
                </li>

                 <li class="nav-item">
                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-competense" role="tab" aria-controls="pills-setting" aria-selected="false">Compétense et éducation</a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <!-- securite -->
                <div class="tab-pane fade" id="previous-secure" role="tabpanel" aria-labelledby="pills-setting-tab">
                    <div class="card-body">
                ...
                <!-- fin -->
                 ...
                 <!-- competense -->
                <div class="tab-pane fade" id="previous-competense" role="tabpanel" aria-labelledby="pills-setting-tab">
                    <div class="card-body">
                        <?php include('object_basic_emplacement.php') ?>
                    </div>
                </div>
                <!-- fin competense -->
