...
<html class="no-js" lang="en">
	             ...
	             <form method="post" id="user_form" enctype="multipart/form-data">
		            <div class="modal-body">
		            	...
		            	<div class="form-group col-md-12 jf-inputwithicon">
				            <label><i class="fa fa-pencil"></i> Nom du contrat</label>
				            
				            <input type="text" name="nomc" id="nomc" class="form-control" placeholder="Entrer le nom du contrat">
 ...
 $(document).ready(function(){  
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'admin/fetch_contrat'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
           ...
           if(nomc != '')
            {
	            ...
	            if (action =="Add") {
	                ...
	                $.ajax({  
	                     url:"<?php echo base_url() . 'admin/operation_contrat/Add'?>",  
	                     method:'POST',  
		        	...
		        	$.ajax({  
                         url:"<?php echo base_url() . 'admin/modification_contrat'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
      ...
      $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url(); ?>admin/fetch_single_contrat",  
                method:"POST",  
                data:{idc:idc},  
                dataType:"json",  
                success:function(data)  
                {  
                     ...
                     $('#nomc').val(data.nomc);
                     $('.modal-title').text("modification du contrat");  
                     $('#idc').val(idc);  
                     $('#action').val("Edit");  
                }  
           });  
          ...
          if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
                      url:"<?php echo base_url(); ?>admin/suppression_contrat",
                      method:"POST",
                      data:{idc:idc},
                      success:function(data)
                      {
