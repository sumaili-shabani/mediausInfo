	             ...
	             <form method="post" id="user_form" enctype="multipart/form-data">
		            <div class="modal-body">
		            	...
		            	<div class="form-group col-md-12 jf-inputwithicon">
				            <label><i class="fa fa-pencil"></i> le nom du service</label>
				            <i class="ti-pencil"></i>
				            <input type="text" name="noms" id="noms" class="form-control" placeholder="Entrez le nom du service">
           ...
           if(noms != '')
            {
	            ...
	            if (action =="Add") {
	                ...
	                $.ajax({  
	                     url:"<?php echo base_url() . 'admin/operation_service/Add'?>",  
	                     method:'POST',  
      ...
      $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                ...
                {  
                     ...
                     $('#noms').val(data.noms);
                     $('.modal-title').text("modification de service "+data.noms);  
                     $('#ids').val(ids);  
                     $('#action').val("Edit");  
                }  
           });  
          ...
          if(confirm("Are you sure you want to delete this?"))
	          {
	           		...
	           		$.ajax({
		              url:"<?php echo base_url(); ?>admin/suppression_service",
		              method:"POST",
		              data:{ids:ids},
		              success:function(data)
		              {
