<div class="chat-panel messagerie_chat" style="display: none;">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-icon close_chat_message" aria-label="Close"><span aria-hidden="true" data-placement="top" title="" data-original-title="Fermer chat">×</span></button>
        </div>
        <div class="card-body">
        ...
        <form class="card-footer my_chat_form" method="post" enctype="multipart/form-data">
            <div class="d-flex justify-content-end">
                ...
                <input type="hiden" name="id_user" id="id_user" class="id_user" value="<?= $this->session->userdata('admin_login') ?>" style="display: none;">
