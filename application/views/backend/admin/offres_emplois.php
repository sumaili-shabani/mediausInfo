    ...
    <body>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                 ...
                 {
                  $.ajax({
                   url:"<?php echo base_url(); ?>admin/pagination_offresEmploi_liste/"+page,
                   method:"GET",
                   dataType:"json",
                 ...
                 {
                      $.ajax({
                       url:"<?php echo base_url(); ?>admin/fetch_search_offresEmploi_pagination",
                       method:"POST",
                       data:{query:query},
                        beforeSend:function()
                        {
                ...
                $(document).on('click','.idcat', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>admin/show_offres_by_categorie",
                    method: "POST",
                    data:{
                      idcat: idcat
                    },
                ...
                $(document).on('click','.idcontrat', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>admin/show_offres_by_contrat",
                    method: "POST",
                    data:{
                      idcontrat: idcontrat
                    },
                ...
                // SALAIRE d'emplois
                 ...
                 $(document).on('click','.idsalaire', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>admin/show_offres_by_salaire",
                    method: "POST",
                    data:{
                      idsalaire: idsalaire
                    },
                 ...
                 $(document).on('click','.qualification', function(){
                  ...
                  $.ajax({
                    url:"<?php echo base_url(); ?>admin/show_offres_by_qualification",
                    method: "POST",
                    data:{
        ...
        $(document).ready(function(){
          var sample_data = new Bloodhound({
           ...
           prefetch:'<?php echo base_url(); ?>admin/fetch_auto_offres',
           remote:{
            url:'<?php echo base_url(); ?>admin/fetch_auto_offres/%QUERY',
            wildcard:'%QUERY'
           }
          });
