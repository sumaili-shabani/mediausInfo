	      ...
	      $(document).on('submit', '#user_form', function(event){  
	           ...
	           {  
	                ...
	                {  
	                     ...
	                     alert("Oups!!! erreur liée du fichier");  
	                     $('#user_image').val('');  
	                     return false;  
	                }  
	           } 
	           ...
	           if(name != '' && subject != '' && email != '' && message != '')
	            ...
	            {
	            	if (name=='') {
	            		alert("error!!!🙆 Veillez complèter le nom");
	            	}
	            	if (subject=='') {
	            		alert("error!!!🙆 Veillez complèter le sujet");
	            	}
	            	if (email=='') {
	            		alert("error!!!🙆 Veillez complèter votre adresse mail");
	            	}
	            	if (message=='') {
	            		alert("error!!!🙆 Veillez complèter le message");
	            	}
