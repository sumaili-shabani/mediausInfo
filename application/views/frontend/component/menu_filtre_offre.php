<div class="col-md-12">
	...
	<div class="col-md-12 card mb-2">
        <div class="row card-body">
            <div class="col-md-12" id="prefetch">
                <input type="text" class="bo-1-rad-3 bocl13 size-a-16 f1-s-19 cl5 plh6 p-rl-18 m-b-20 form-control typeahead search_text" id="inlineFormInputGroupUsername2" placeholder="Rechecher une offre...">
            </div>
        </div>
    </div>
    <!-- fin recherche -->
