...
! function(e) {
    e(".eg-swal-default").on("click", function(e) {
        ...
        Swal.fire("The Internet?", "That thing is still around?"), e.preventDefault()
    }), e(".eg-swal-success").on("click", function(e) {
        Swal.fire("Good job!", "You clicked the button!", "success"), e.preventDefault()
    }), e(".eg-swal-info").on("click", function(e) {
        Swal.fire("Good job!", "You clicked the button!", "info"), e.preventDefault()
    }), e(".eg-swal-warning").on("click", function(e) {
        Swal.fire("Good job!", "You clicked the button!", "warning"), e.preventDefault()
    }), e(".eg-swal-error").on("click", function(e) {
        Swal.fire("Good job!", "You clicked the button!", "error"), e.preventDefault()
    }), e(".eg-swal-question").on("click", function(e) {
        Swal.fire("Good job!", "You clicked the button!", "question"), e.preventDefault()
